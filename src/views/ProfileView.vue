...
const user = {
  ...
  bio: '"Working on water conservation and community mobilization in Ward 4"',
  stats: {
    actions: 24,
    issuesResolved: 10,
    posts: 8
  ...
  <div class="min-h-full bg-gray-50/50 pb-6">
    ...
    <div class="bg-white pb-6 rounded-b-[2rem] shadow-sm mb-6 border-b border-gray-100">
      <div class="flex flex-col items-center pt-8 px-6 text-center">
        ...
        <div class="w-24 h-24 rounded-full overflow-hidden bg-gray-200 border-4 border-white shadow-lg mb-4">
          <img src="https://images.unsplash.com/photo-1599566150163-29194dcaad36?w=200&q=80" class="w-full h-full object-cover" />
        </div>
    ...
    <div class="px-5">
      ...
      <div class="grid grid-cols-3 gap-3">
        <div class="bg-white border border-gray-100 p-4 rounded-2xl flex flex-col justify-center items-center text-center shadow-sm hover:shadow-md transition-shadow">
